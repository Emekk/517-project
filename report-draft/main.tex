...
\setlength\bibhang{0.5in} % hanging indent for bibliography
...
\input{contents/review.tex}
\input{contents/gaps-and-shortcomings.tex}
\input{contents/future-research-topics.tex}
